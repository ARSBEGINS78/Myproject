...
const Nav_im = ({ scrollToSection, homeRef, aboutRef, contactusRef, pricetierRef, formRef, logo}) => {
  return (
    <div>
          <img alt="Digi" className='h-screen w-full object-cover' src="https://images.unsplash.com/photo-1553877522-43269d4ea984?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8ZGlnaXRhbCUyMG1hcmtldGluZ3xlbnwwfHwwfHx8MA%3D%3D"/>
              <img alt="digilogo" className='absolute top-2 left-2 md:left-4 h-24 md:h-40 z-30' src={logo} />      
